...
public abstract class Heuristic {
  ...
  public static Map<String, NamedEntity> categoryMap = Map.of(
      ...
      "USA", (new Place("USA","International Politics", 0, p_USA, c_USA, d_USA, o_USA)),
      "Russia", (new Place("Russia","International Politics", 0, p_Russia, c_Russia, d_Russia, o_Russia)));
